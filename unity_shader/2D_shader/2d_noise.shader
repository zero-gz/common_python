// Upgrade NOTE: replaced 'defined Use_Simplex' with 'defined (Use_Simplex)'
// Upgrade NOTE: replaced 'defined Use_Value' with 'defined (Use_Value)'

Shader "my_shader/2d_noise"
{
	Properties
	{
		_MainTex ("Texture", 2D) = "white" {}
	_Speed("_Speed", Vector) = (0.0, 0.0 ,0.0, 0.0)
	}
		SubShader
	{
		...
		Pass
		{
			...
			#include "shadertoy_header.cginc"
