...
public class geometry_util
{

    public static Mesh generate_plane(float width, float length, float cellSize)
    {
    ...
    public static Mesh generate_box(float width, float length, float depth, float cellSize)
    {
        int xsize = Mathf.RoundToInt(width / cellSize);
        int ysize = Mathf.RoundToInt(length / cellSize);
    ...
    public static void draw_wire_plane(Vector3 position, float angle, float width, float length, Color color)
    {
    ...
    public static void draw_wire_cube(Vector3 position, float angle, float width, float length, float minHeight,
